...
declare module 'puppeteer' {
  ...
  import { ProtocolMapping } from 'devtools-protocol/protocol-mapping'
  ...
  interface CDPSession_2 extends EventEmitter {
    send<T extends keyof ProtocolMapping.Commands>(
      method: T,
      ...paramArgs: ProtocolMapping.Commands[T]['paramsType']
    ): Promise<ProtocolMapping.Commands[T]['returnType']>
  ...
  interface CDPSession_3 extends EventEmitter {
    send<T extends keyof ProtocolMapping.Commands>(
      method: T,
      ...paramArgs: ProtocolMapping.Commands[T]['paramsType']
    ): Promise<ProtocolMapping.Commands[T]['returnType']>
  ...
  interface CDPSession_4 extends EventEmitter {
    send<T extends keyof ProtocolMapping.Commands>(
      method: T,
      ...paramArgs: ProtocolMapping.Commands[T]['paramsType']
    ): Promise<ProtocolMapping.Commands[T]['returnType']>
  ...
  export class Page extends EventEmitter {
    ...
    waitForRequest(
      urlOrPredicate:
        | string
        | ((req: HTTPRequest) => boolean | Promise<boolean>),
      options?: {
        timeout?: number
      }
    ): Promise<HTTPRequest>
   ...
   * @public
   */
  export type PredefinedNetworkConditions = {
